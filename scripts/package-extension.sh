...
mkdir -p "$dist_dir"
temporary_dir="$(mktemp -d "$dist_dir/.jeffrey-video-digest-package.XXXXXX")"
temporary_zip="$temporary_dir/jeffrey-video-digest.zip"
output_zip="$dist_dir/jeffrey-video-digest-v$version.zip"
